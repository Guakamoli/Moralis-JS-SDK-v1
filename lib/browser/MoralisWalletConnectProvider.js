...
function _regeneratorRuntime() {
  ...
  function defineIteratorMethods(prototype) {
    var _context3;
    _forEachInstanceProperty(_context3 = ["next", "throw", "return"]).call(_context3, function (method) {
  ...
  return GeneratorFunction.prototype = GeneratorFunctionPrototype, defineProperty(Gp, "constructor", {
    ...
    reset: function (skipTempReset) {
      var _context4;
      if (this.prev = 0, this.next = 0, this.sent = this._sent = undefined, this.done = !1, this.delegate = null, this.method = "next", this.arg = undefined, _forEachInstanceProperty(_context4 = this.tryEntries).call(_context4, resetTryEntry), !skipTempReset) for (var name in this) {
