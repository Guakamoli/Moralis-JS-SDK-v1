...
function _unsupportedIterableToArray(o, minLen) {
  ...
  var n = _sliceInstanceProperty(_context23 = Object.prototype.toString.call(o)).call(_context23, 8, -1);
...
function _regeneratorRuntime() {
  ...
  var exports = {},
    ...
    defineProperty = _Object$defineProperty2 || function (obj, key, desc) {
      obj[key] = desc.value;
    },
  ...
  function defineIteratorMethods(prototype) {
    var _context21;
    _forEachInstanceProperty2(_context21 = ["next", "throw", "return"]).call(_context21, function (method) {
  ...
  return GeneratorFunction.prototype = GeneratorFunctionPrototype, defineProperty(Gp, "constructor", {
    ...
    reset: function (skipTempReset) {
      var _context22;
      if (this.prev = 0, this.next = 0, this.sent = this._sent = undefined, this.done = !1, this.delegate = null, this.method = "next", this.arg = undefined, _forEachInstanceProperty2(_context22 = this.tryEntries).call(_context22, resetTryEntry), !skipTempReset) for (var name in this) {
...
var ParseObject = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(ParseObject, [{
    ...
    key: "exists",
    value: function () {
      var _exists = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(options /*:: ?: RequestOptions*/) {
        var query;
    ...
    key: "isPinned",
    value: function () {
      var _isPinned = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    value: function () {
      var _fetchFromLocalDatastore = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    ...
    key: "fromJSON",
    value: function (json /*: any*/, override /*:: ?: boolean*/) {
      if (!json.className) {
  ...
  fetch: function (target /*: ParseObject | Array<ParseObject>*/, forceFetch /*: boolean*/, options /*: RequestOptions*/) /*: Promise<Array<void> | ParseObject>*/{
    ...
    if ((0, _isArray.default)(target)) {
      ...
      return (0, _find.default)(query).call(query, options).then( /*#__PURE__*/function () {
        var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(objects) {
    ...
    if (target instanceof ParseObject) {
      ...
      return RESTController.request('GET', (0, _concat.default)(_context9 = "classes/".concat(target.className, "/")).call(_context9, target._getId()), params, options).then( /*#__PURE__*/function () {
        var _ref2 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(response) {
        ...
        while (1) {
          switch (_context16.prev = _context16.next) {
            ...
            case 6:
              ...
              return _context16.abrupt("return", deleteCompleted.then( /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
            ...
            case 13:
              ...
              return _context16.abrupt("return", RESTController.request('DELETE', (0, _concat.default)(_context14 = "classes/".concat(target.className, "/")).call(_context14, target._getId()), {}, options).then( /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
  ...
  save: function (target /*: ParseObject | Array<ParseObject | ParseFile>*/, options /*: RequestOptions*/) {
    ...
    if ((0, _isArray.default)(target)) {
      ...
      return _promise.default.all(filesSaved).then(function () {
        ...
        }).then( /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
    ...
    if (target instanceof ParseObject) {
      ...
      return stateController.enqueueTask(target._getStateIdentifier(), task).then( /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
