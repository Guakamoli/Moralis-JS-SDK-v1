...
var ParseCLP = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(ParseCLP, [{
    ...
    key: "equals",
    value: function (other /*: ParseCLP*/) /*: boolean*/{
    ...
    key: "_getRoleName",
    value: function (role /*: ParseRole | string*/) /*: string*/{
      var name = role;
    ...
    key: "_setAccess",
    value: function (permission /*: string*/, userId /*: Entity*/, allowed /*: boolean*/) {
    ...
    key: "_getAccess",
    value: function (permission /*: string*/, userId /*: Entity*/) /*: boolean | string[]*/{
    ...
    key: "_setArrayAccess",
    value: function (permission /*: string*/, userId /*: Entity*/, fields /*: string*/) {
      userId = this._parseEntity(userId);
      var permissions = this.permissionsMap[permission][userId];
      if (!permissions) {
        this.permissionsMap[permission][userId] = [];
    ...
    value: function (operation /*: string*/, pointerFields /*: string[]*/) {
    ...
    value: function (operation /*: string*/) /*: string[]*/{
    ...
    value: function (pointerFields /*: string[]*/) {
    ...
    value: function (userId /*: Entity*/, fields /*: string[]*/) {
    ...
    value: function (userId /*: Entity*/) /*: string[]*/{
    ...
    key: "setReadAccess",
    value: function (userId /*: Entity*/, allowed /*: boolean*/) {
    ...
    key: "getReadAccess",
    value: function (userId /*: Entity*/) /*: boolean*/{
    ...
    value: function (role /*: ParseRole | string*/, fields /*: string[]*/) {
