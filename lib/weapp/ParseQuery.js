...
var ParseQuery = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(ParseQuery, [{
    ...
    value: function () {
      var _handleOfflineQuery2 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(params /*: any*/) {
        var _context,
          _this2 = this;
    ...
    key: "findAll",
    value: function () {
      var _findAll = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(options /*:: ?: BatchOptions*/) {
        var result;
    ...
    key: "map",
    value: function () {
      var _map = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(callback /*: (currentObject: ParseObject, index: number, query: ParseQuery) => any*/, options /*:: ?: BatchOptions*/) {
        var array, index;
    ...
    key: "reduce",
    value: function () {
      var _reduce = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(callback /*: (accumulator: any, currentObject: ParseObject, index: number) => any*/, initialValue /*: any*/, options /*:: ?: BatchOptions*/) {
    ...
    key: "filter",
    value: function () {
      var _filter = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(callback /*: (currentObject: ParseObject, index: number, query: ParseQuery) => boolean*/, options /*:: ?: BatchOptions*/) {
        var array, index;
    ...
    key: "startsWith",
    value: function (key /*: string*/, prefix /*: string*/) /*: ParseQuery*/{
    ...
    key: "endsWith",
    value: function (key /*: string*/, suffix /*: string*/) /*: ParseQuery*/{
    ...
    key: "onChange",
    value: function (onUpdate /*: any*/, onError /*:: ?: any*/ /*:: ?: string*/) /*: Promise<LiveQuerySubscription>*/{
      var sub = null;
    ...
    key: "subscribe",
    value: function () {
      var _subscribe = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(sessionToken /*:: ?: string*/) {
